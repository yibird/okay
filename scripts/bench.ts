...
import { asyncTo } from '../src/async/asyncTo'
import { deferred } from '../src/async/deferred'
import { parallel } from '../src/async/parallel'
import { settleObject } from '../src/async/settleObject'
import { raceObject } from '../src/async/raceObject'
import { singleFlight } from '../src/async/singleFlight'
import { batchSync } from '../src/async/batchSync'
import { timeSlice } from '../src/async/timeSlice'
import { diffArray } from '../src/coll/array/diffArray'
import { fastIndexedMap } from '../src/coll/array/fastIndexedMap'
import { fastStableSort } from '../src/coll/array/fastStableSort'
import { diffTree } from '../src/coll/tree/diffTree'
import { depth } from '../src/coll/tree/depth'
import { leaves } from '../src/coll/tree/leaves'
import { mapTree } from '../src/coll/tree/mapTree'
import { treeToList } from '../src/coll/tree/treeToList'
import { treeToSet } from '../src/coll/tree/treeToSet'
import { businessDays } from '../src/date/common/businessDays'
import { relativeTime } from '../src/date/common/relativeTime'
import { isBusinessDay } from '../src/date/common/isBusinessDay'
import { isSameDay } from '../src/date/common/isSameDay'
import { formatBytes } from '../src/file/formatBytes'
import { fileExt } from '../src/file/fileExt'
import { fileParts } from '../src/file/fileParts'
...
import { rawType } from '../src/is/rawType'
import { createNumberFormatter } from '../src/number/createNumberFormatter'
import { formatCompactNumber } from '../src/number/formatCompactNumber'
import { formatCurrency } from '../src/number/formatCurrency'
import { formatNumber } from '../src/number/formatNumber'
import { formatPercent } from '../src/number/formatPercent'
import { mask, maskBankCard, maskEmail, maskIdCard, maskName, maskPhone } from '../src/string/index'
...
interface MappedTreeNode extends Record<string, unknown> {
  id: number
  children?: MappedTreeNode[]
}
...
const changedTree = mapTree<TreeNode, MappedTreeNode>(tree, (node) => ({ id: node.id }))
