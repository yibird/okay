...
describe('quarterRange', () => {
  ...
  it('should return correct quarter range', () => {
    const result = quarterRange('2023-05-15')
  ...
  it('should have correct time boundaries', () => {
    const { startTime, endTime } = quarterRange('2023-11-20')
  ...
  it('should handle year transition', () => {
    const result = quarterRange('2022-12-31')
  ...
  it('should provide string representation', () => {
    const result = quarterRange('2023-08-01')
    expect(result.toString()).toBe('Q3-2023')
  })

  it('should reject invalid dates', () => {
    expect(() => quarterRange('invalid-date')).toThrow('Invalid date provided')
  })
})
