...
describe('weekOfYear', () => {
  ...
  it('should default to current date when no argument is provided', () => {
    const expected = weekOfYear(dayjs())
    const result = weekOfYear()
