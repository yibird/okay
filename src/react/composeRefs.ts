import { setRef, type MaybeCleanupRef, type RefCleanup } from './setRef'

export type ComposedRef<T> = (value: T | null) => RefCleanup | void
...
export function composeRefs<T>(
  ...refs: Array<MaybeCleanupRef<T> | undefined | null>
): ComposedRef<T> {
  return (value) => {
