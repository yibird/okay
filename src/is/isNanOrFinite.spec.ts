...
import { isNaNOrFinite } from './isNanOrFinite' // 请替换为实际路径
...
describe('isNaNOrFinite', () => {
  ...
  describe('comparison with native methods', () => {
    ...
    it('show difference from global isNaN', () => {
      testValues.forEach((value) => {
        ...
        console.log(`Value: ${value}, Our: ${ourResult}, Global: ${globalResult}`)
      })
    })
  ...
  describe('combined scenarios', () => {
    it('mixed values in real-world scenario', () => {
      ...
      expect(validNumericData.every((item) => typeof item === 'number')).toBe(true)
    })
  })
})
