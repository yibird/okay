...
import { isFinite } from './isFinite' // 请替换为实际路径
...
describe('isFinite', () => {
  ...
  describe('type guard functionality', () => {
    ...
    it('should work in array filter with type narrowing', () => {
      const mixedArray: unknown[] = [1, '2', 3.14, NaN, Infinity, -Infinity, null, undefined, true]
  ...
  describe('performance', () => {
    it('should handle large numbers of inputs quickly', () => {
      const testArray = Array.from({ length: 10000 }, (_, i) => (i % 2 === 0 ? i : i.toString()))
