...
describe('isBool utility function', () => {
  ...
  // 3. Edge cases
  it('should handle boolean primitives with modified prototype attempts', () => {
  ...
  it('should handle boolean values from different realms', () => {
    ...
    if (typeof document !== 'undefined') {
      ...
      try {
        const iframeBool = iframe.contentWindow?.window?.Boolean(true) ?? Boolean(true)
