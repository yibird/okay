...
describe('quarterOfYear', () => {
  ...
  it('should return correct Q1 details for dates in Q1', () => {
    ...
    const result = quarterOfYear(date)
  ...
  it('should accept timestamp as input', () => {
    ...
    const result = quarterOfYear(timestamp)
  ...
  it('should handle quarter boundary dates correctly', () => {
    // Last day of Q1
    const q1End = quarterOfYear('2023-03-31')
    expect(q1End.quarter).toBe(1)

    // First day of Q2
    const q2Start = quarterOfYear('2023-04-01')
    expect(q2Start.quarter).toBe(2)

    // Last day of Q4
    const q4End = quarterOfYear('2023-12-31')
    expect(q4End.quarter).toBe(4)
  })

  it('should handle leap year February correctly', () => {
    const leapYearQ1 = quarterOfYear('2024-02-29')
  ...
  it('should reject invalid dates', () => {
    expect(() => quarterOfYear('invalid-date')).toThrow('Invalid date provided')
  })
})
