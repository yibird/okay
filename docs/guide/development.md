...
框架无关逻辑优先放在 `src` 下的通用模块。只有依赖 Vue 或 React 运行时的能力，才放在 `src/vue` 或 `src/react`。
...
| 内容     | 要求                                                                                                                                |
| -------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| 导入示例 | 只从公开入口导入，例如 `@zhouchengfeng/okay`、`@zhouchengfeng/okay/async`、`@zhouchengfeng/okay/vue`、`@zhouchengfeng/okay/react`。 |
